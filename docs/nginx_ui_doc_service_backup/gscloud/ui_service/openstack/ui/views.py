...
def homepage(request):
    jwt_toke = {'uid': "Padmakar", 'gid': "staff", 'token': 'dskjeds@3dslklkf'}
...
def homepagetest(request):
    ...
    T = ('touple', 12)
    jwt_token = {'jwt_token':jwt_toke, 'data': L, 'T':T}
    return render(request, 'ui/home/backup/home_org.html', {'jwt_token': jwt_token})
...
def docs(request):
    ...
    T = ('touple', 12)
    jwt_token = {'jwt_token':jwt_toke, 'data': L, 'T':T}
    #return render(request, 'ui/documentation/docs.html', {'jwt_token': jwt_token})
    return render(request, 'ui/documentation/docs.html', {'jwt_token': jwt_token})
...
def servicedesk(request):
    ...
    T = ('touple', 12)
    jwt_token = {'jwt_token':jwt_toke, 'data': L, 'T':T}
    return render(request, 'ui/servicedesk/servicedesk.html', {'jwt_token': jwt_token})
...
def static(request):
    ...
    T = ('touple', 12)
    jwt_token = {'jwt_token':jwt_toke, 'data': L, 'T':T}
    return render(request, 'ui/static/servicedesk.html', {'jwt_token': jwt_token})
...
def fbapi_uf_list(request):
    ...
    if request.method == "GET":
        ...
        return render(request, 'ui/home/home_org.html', {'form': form})
...
def fbapi_uf_new(request):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            print("---File data --", file_name, file_content_type, file_size, type(formdata['upload_image']), type(file_data))
            ...
            # Following commented exmaple returns error data in dic.
            # return render(request,'500.html', {'error':form.errors.as_data()})
            # Following commented exmaple returns error data in json
            ...
            return render(request, '500.html', {'error': form.errors.as_json()})
    else:
...
def login(request):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            print("---data - ", type(data), data)
            return render(request, 'ui/accounts/login.html', {'data':data, 'formdata': formdata, 'file':file_name})
                #return render(request, 'ui/fbapi/fbapi_list.html')
                #return redirect('/fbapi_uf/list/')
            #else:
            #   return render(request,'500.html', {'error': r.status_code})
        ...
        #return render(request, 'ui/fbapi/fbapi_new.html', {'form': form})
        return render(request, 'ui/accounts/login.html', {'form': form})
...
def signup(request):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            print("---data - ", type(data), data)
            return render(request, 'ui/accounts/signup.html', {'data':data, 'formdata': formdata, 'file':file_name})
                #return render(request, 'ui/fbapi/fbapi_list.html')
                #return redirect('/fbapi_uf/list/')
            #else:
            #   return render(request,'500.html', {'error': r.status_code})
        ...
        #return render(request, 'ui/fbapi/fbapi_new.html', {'form': form})
        return render(request, 'ui/accounts/signup.html', {'form': form})
